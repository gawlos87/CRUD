...
namespace CRUD {
    ...
    public partial class PracownicyDataSet : global::System.Data.DataSet {
        ...
        public partial class EmployeesDataTable : global::System.Data.TypedTableBase<EmployeesRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public EmployeesRow AddEmployeesRow(int ID, string NAME, string SURNAME, int AGE) {
...
namespace CRUD.PracownicyDataSetTableAdapters {
    ...
    public partial class EmployeesTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Employees] WHERE (([ID] = @Original_ID) AND ([NAME] = @Origina" +
                "l_NAME) AND ([SURNAME] = @Original_SURNAME) AND ([AGE] = @Original_AGE))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Employees] ([ID], [NAME], [SURNAME], [AGE]) VALUES (@ID, @NAME" +
                ", @SURNAME, @AGE);\r\nSELECT ID, NAME, SURNAME, AGE FROM Employees WHERE (ID = @ID" +
                ")";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Employees] SET [ID] = @ID, [NAME] = @NAME, [SURNAME] = @SURNAME, [AGE] = @AGE WHERE (([ID] = @Original_ID) AND ([NAME] = @Original_NAME) AND ([SURNAME] = @Original_SURNAME) AND ([AGE] = @Original_AGE));
SELECT ID, NAME, SURNAME, AGE FROM Employees WHERE (ID = @ID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::CRUD.Properties.Settings.Default.PracownicyConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ID, NAME, SURNAME, AGE FROM dbo.Employees";
        ...
        public virtual int Fill(PracownicyDataSet.EmployeesDataTable dataTable) {
        ...
        public virtual PracownicyDataSet.EmployeesDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            PracownicyDataSet.EmployeesDataTable dataTable = new PracownicyDataSet.EmployeesDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(PracownicyDataSet.EmployeesDataTable dataTable) {
        ...
        public virtual int Delete(int Original_ID, string Original_NAME, string Original_SURNAME, int Original_AGE) {
        ...
        public virtual int Insert(int ID, string NAME, string SURNAME, int AGE) {
        ...
        public virtual int Update(int ID, string NAME, string SURNAME, int AGE, int Original_ID, string Original_NAME, string Original_SURNAME, int Original_AGE) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string NAME, string SURNAME, int AGE, int Original_ID, string Original_NAME, string Original_SURNAME, int Original_AGE) {
            return this.Update(Original_ID, NAME, SURNAME, AGE, Original_ID, Original_NAME, Original_SURNAME, Original_AGE);
        }
    }
